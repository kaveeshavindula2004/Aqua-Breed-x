...
import { CameraIcon, ParentFishIcon } from './Icons';
  ...
  return (
    <div className="animate-fade-in h-full p-2 pb-20">
      ...
      <div className="bg-white dark:bg-slate-800/50 rounded-xl p-4 mb-4">
        <h2 className="text-xl font-bold mb-3">Profile Settings</h2>
        <div className="flex items-center space-x-4 mb-4">
            <div className="relative w-20 h-20 flex-shrink-0">
                <img 
                    src={profile.profilePicture || 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7'} 
                    alt="Profile" 
        ...
        <div className="flex justify-end mt-4">
            <button onClick={handleSave} className={`px-4 py-2 rounded-lg text-sm font-semibold transition-colors text-white ${isSaved ? 'bg-green-600' : 'bg-sky-600 hover:bg-sky-700'}`}>
      ...
      <div className="bg-white dark:bg-slate-800/50 rounded-xl p-4 mt-4">
        <h2 className="text-xl font-bold mb-2">Species Timelines</h2>
